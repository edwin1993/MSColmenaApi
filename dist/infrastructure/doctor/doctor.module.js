...
const doctor_controller_1 = require("../../interface/doctor/doctor.controller");
const doctor_service_1 = require("../../application/doctor/doctor.service");
const prisma_doctor_repository_1 = require("./prisma-doctor.repository");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            doctor_service_1.DoctorService,
            {
                ...
                useClass: prisma_doctor_repository_1.PrismaDoctorRepository,
            },
        ],
